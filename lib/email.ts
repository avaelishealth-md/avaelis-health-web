...
export function talkSummaryEmail(opts: { name?: string; title?: string; summaryHtml?: string }): string {
  ...
  <div style="max-width:600px;margin:0 auto;padding:32px 18px">
    <div style="background:#F8F3E9;border:1px solid #DBCFB7;border-radius:16px;padding:32px 30px">
      ...
      <div style="background:#5A3A42;border-radius:12px;padding:22px;margin:24px 0;text-align:center">
        ...
        <a href="https://www.avaelishealth.com.au/#education" style="background:#9A7536;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:100px;font-size:14px;display:inline-block">Explore the CPD course</a>
      </div>
