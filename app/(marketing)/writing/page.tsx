    ...
    <>
      <div className="phero">
        <div className="wrap">
          ...
          <p className="lede">Properly researched writing on longevity and precision wellness. Never a sales pitch, never individual medical advice, just the considered view.</p>
        </div>
      </div>
      <div className="pad-s wrap">
        <a className="feat-art" href="#article" style={{ textDecoration: "none", color: "inherit" }}>
          ...
          <div className="ab"><span className="cat">Featured · Diagnostics</span><h2 className="big" style={{ fontSize: "32px", margin: "12px 0" }}>What a DEXA scan actually tells you</h2><p className="lede" style={{ fontSize: "16px" }}>Beyond BMI: visceral fat, lean mass and bone density, and why a single number on the scales hides the story that matters.</p><span className="mono" style={{ fontSize: "11px", color: "var(--muted)", display: "block", marginTop: "16px" }}>8 min read · Dr. Danny Cai</span></div>
        </a>
      </div>
      <div className="pad-s wrap">
        <div className="g3">
      ...
      <div className="band"><div className="pad-s wrap split">
        <div><div className="rule" style={{ background: "var(--bronze-l)" }}></div><span className="ov">The dispatch</span><h2 className="big" style={{ color: "#fff", marginTop: "12px" }}>Considered notes, on occasion.</h2><p className="lede" style={{ color: "var(--muted-l)", marginTop: "14px" }}>Infrequent, evidence-led writing from Dr. Danny. No noise.</p></div>
