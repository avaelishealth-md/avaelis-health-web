    ...
    <>
        ...
        <section className="journey" id="approach">
          <div className="wrap">
            ...
            <div className="track reveal">
              ...
              <div className="jn reveal"><div className="dot">5</div><h3>Optimise</h3><p>Retest, review, refine. Never single consults.</p></div>
            </div>
      ...
      <footer>
        <div className="wrap">
          ...
          <div className="foot-bot"><span>© 2026 AvaElis Health · <a href="mailto:info@avaelishealth.com.au">info@avaelishealth.com.au</a></span><span><a href="/privacy">Privacy</a> · <a href="/terms">Terms</a></span></div>
        </div>
      </footer>
